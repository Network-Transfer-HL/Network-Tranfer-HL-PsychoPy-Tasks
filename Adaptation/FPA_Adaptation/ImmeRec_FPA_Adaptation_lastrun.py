...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/charlotte/Desktop/DOCUMENTS/UNI/MEDIZIN/PROMOTION/Behaviour/PsychoPy/Adaptation/FPA_Adaptation/ImmeRec_FPA_Adaptation_lastrun.py',
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('FPA_ImmRec_Stimulus_List.xlsx', selection='0:6'),
