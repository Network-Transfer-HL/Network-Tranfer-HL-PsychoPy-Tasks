...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='H:\\Luebeck\\Projects\\Juniorfoerderung\\Tasks\\Pilot\\NSWP\\Lernen_NSWP_Pilot_v2_lastrun.py',
...
for thisEncode2 in Encode2:
    ...
    for thisComponent in WordPairPresentationComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    Encode2.addData('Target_Background.started', Target_Background.tStartRefresh)
    Encode2.addData('Target_Background.stopped', Target_Background.tStopRefresh)
    Encode2.addData('Cue_Background.started', Cue_Background.tStartRefresh)
    Encode2.addData('Cue_Background.stopped', Cue_Background.tStopRefresh)
    Encode2.addData('CueWord.started', CueWord.tStartRefresh)
    Encode2.addData('CueWord.stopped', CueWord.tStopRefresh)
    Encode2.addData('TargetWord.started', TargetWord.tStartRefresh)
    Encode2.addData('TargetWord.stopped', TargetWord.tStopRefresh)
