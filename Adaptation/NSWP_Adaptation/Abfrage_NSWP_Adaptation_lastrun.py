...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/charlotte/Desktop/DOCUMENTS/UNI/MEDIZIN/PROMOTION/Behaviour/PsychoPy/Adaptation/NSWP_Adaptation/Abfrage_NSWP_Adaptation_lastrun.py',
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('NSWP_Abfrage_Stimulus_List.xlsx', selection='0:6'),
