...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/charlotte/Desktop/DOCUMENTS/UNI/MEDIZIN/PROMOTION/PsychoPy/Measurement/FPA_Measurement/Abfrage_FPA_Pilot_v1_lastrun.py',
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('FPA_Abfrage_Stimulus_List.xlsx', selection='0:60'),
